...
#define LON_GRID_DIM_MAX 100000 // X  - used to be 10260 in non-MPI version
#define LAT_GRID_DIM_MAX 100000 // Y   - used to be 19010 in non-MPI version
...
#define MAX_NUM_GEN_MULTI_PROFILES 300000 // the maximum number of profiles able to be generated by GEN_MULTI_PROFILES_CALL
#define MAX_NUM_GRIDPOINTS 19078957 // the maximum number of gridpoints able to be read from gridpoints textfile
