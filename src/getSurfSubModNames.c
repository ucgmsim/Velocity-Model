...
global_model_parameters *getGlobalModelParameters(char *modelVersion, char *TOPO_TYPE)
...
//        GLOBAL_MODEL_PARAMETERS->nBasin = 2;
    ...
    //          Korean VM (KVM) versions
    
    //==========================================================

    else if(strcmp(modelVersion,"KVM_20p6") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
        ...
        GLOBAL_MODEL_PARAMETERS->veloSubMod[0] = "NaNsubMod";
        GLOBAL_MODEL_PARAMETERS->veloSubMod[1] = "v1DsubMod";
        GLOBAL_MODEL_PARAMETERS->veloMod1dFileName[0] = "1D_20p6.txt";

        GLOBAL_MODEL_PARAMETERS->nBasins = 0;
    }

    else if(strcmp(modelVersion,"KVM_20p12") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
    ...
    else if(strcmp(modelVersion,"1.64") == 0)
    {
        ...
        GLOBAL_MODEL_PARAMETERS->nBasins = 2;
        GLOBAL_MODEL_PARAMETERS->basin[0] = "Canterbury_Pre_Quaternary_v18p1";
    ...
    else if(strcmp(modelVersion,"1.65") == 0)
    {
        ...
        GLOBAL_MODEL_PARAMETERS->nBasins = 2;
        GLOBAL_MODEL_PARAMETERS->basin[0] = "Canterbury_Pre_Quaternary_v18p2";
        GLOBAL_MODEL_PARAMETERS->basin[1] = "Banks_Peninsula_Volcanics_v19p1";
    ...
    else if(strcmp(modelVersion,"2.01") == 0)
    {
        ...
        GLOBAL_MODEL_PARAMETERS->basin[8] = "Wellington_v19p1";
    ...
    else if(strcmp(modelVersion,"2.03") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
        ...
        // Basin names for this model version
        GLOBAL_MODEL_PARAMETERS->nBasins = 10;
        GLOBAL_MODEL_PARAMETERS->basin[0] = "Canterbury_Pre_Quaternary_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[1] = "Cantebury_North_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[2] = "Banks_Peninsula_Volcanics_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[3] = "Kaikoura_v19p1";
    ...
    else if(strcmp(modelVersion,"2.04") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
        ...
        // Basin names for this model version
        GLOBAL_MODEL_PARAMETERS->nBasins = 26;
        GLOBAL_MODEL_PARAMETERS->basin[0] = "Canterbury_Pre_Quaternary_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[1] = "Cantebury_North_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[2] = "Banks_Peninsula_Volcanics_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[3] = "Kaikoura_v19p1";
    ...
    else if(strcmp(modelVersion,"2.05") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
    ...
    else if(strcmp(modelVersion,"2.05_no_basins") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
        ...
        GLOBAL_MODEL_PARAMETERS->veloSubMod[0] = "NaNsubMod";
        GLOBAL_MODEL_PARAMETERS->veloSubMod[1] = "EPtomo2010subMod";
        GLOBAL_MODEL_PARAMETERS->tomographyName = "2020_NZ_OFFSHORE_NO_BASIN";
    ...
    else if(strcmp(modelVersion,"2.05_m12") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
        ...
        GLOBAL_MODEL_PARAMETERS->nBasins = 27;
        GLOBAL_MODEL_PARAMETERS->basin[0] = "Perturbation_v20p11";
        GLOBAL_MODEL_PARAMETERS->basin[1] = "Canterbury_Pre_Quaternary_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[2] = "Cantebury_North_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[3] = "Banks_Peninsula_Volcanics_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[4] = "Kaikoura_v19p1";
        ...
        GLOBAL_MODEL_PARAMETERS->basin[9] = "Wellington_v19p6";
        GLOBAL_MODEL_PARAMETERS->basin[10] = "WaikatoHauraki_v19p7";
        GLOBAL_MODEL_PARAMETERS->basin[11] = "Wanaka_v20p6";
        GLOBAL_MODEL_PARAMETERS->basin[12] = "MacKenzie_v20p6";
        GLOBAL_MODEL_PARAMETERS->basin[13] = "Wakatipu_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[14] = "Alexandra_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[15] = "Ranfurly_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[16] = "NE_Otago_A_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[17] = "NE_Otago_B_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[18] = "NE_Otago_C_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[19] = "NE_Otago_D_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[20] = "NE_Otago_E_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[21] = "Mosgiel_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[22] = "Balclutha_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[23] = "Dunedin_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[24] = "Murchison_v20p7";
        GLOBAL_MODEL_PARAMETERS->basin[25] = "Waitaki_v20p8";
        GLOBAL_MODEL_PARAMETERS->basin[26] = "Hakataramea_v20p8";
        
        
    }
        else if(strcmp(modelVersion,"2.06") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
        ...
        // Basin names for this model version
        GLOBAL_MODEL_PARAMETERS->nBasins = 31;
        GLOBAL_MODEL_PARAMETERS->basin[0] = "Canterbury_Pre_Quaternary_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[1] = "Cantebury_North_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[2] = "Banks_Peninsula_Volcanics_v19p1";
        GLOBAL_MODEL_PARAMETERS->basin[3] = "Kaikoura_v19p1";
        ...
        else if(strcmp(modelVersion,"2.07") == 0)
    {
        // define the number of surfaces and sub models
        GLOBAL_MODEL_PARAMETERS->nSurf = 3;
        GLOBAL_MODEL_PARAMETERS->nVeloSubMod = 2;
        ...
        GLOBAL_MODEL_PARAMETERS->basin[52] = "Motu_Bay1_v22p5";
        GLOBAL_MODEL_PARAMETERS->basin[53] = "Motu_Bay2_v22p5";
        GLOBAL_MODEL_PARAMETERS->basin[54] = "Motu_Bay3_v22p5";
        GLOBAL_MODEL_PARAMETERS->basin[55] = "TolagaBay_v22p5";
    }
